...
import {
    ...
    Sparkles, Zap, ChevronRight, BarChart3, TrendingDown, Target
} from "lucide-react";
...
interface SemanticPulseClientProps {
    data: MarketPulseData;
}

export default function SemanticPulseClient({ data }: SemanticPulseClientProps) {
    return (
                    ...
                    <div className="lg:col-span-7 space-y-10">
                        <motion.div variants={itemVariants} className="bg-[#0D0D0F] border border-white/[0.05] rounded-3xl p-8 relative overflow-hidden">
                            ...
                            <div className="space-y-6">
                                {data.pillars.map((pillar: PulsePillar, i: number) => (
                        ...
                        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {data.competitor_insights.map((insight: CompetitorInsight, i: number) => (
                    ...
                    <div className="lg:col-span-5 space-y-10">
                        ...
                        <motion.div variants={itemVariants} className="bg-[#0D0D0F] border border-white/[0.05] rounded-3xl overflow-hidden shadow-2xl backdrop-blur-sm">
                            ...
                            <div className="divide-y divide-white/[0.03]">
                                {data.investment_roadmap.map((plan: InvestmentItem, i: number) => (
