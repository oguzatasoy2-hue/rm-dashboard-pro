            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[200] cursor-crosshair"
                    />
                    ...
                    <div className="fixed inset-0 flex items-center justify-center z-[210] p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="w-full max-w-md bg-[#09090B] border border-white/[0.08] rounded-[32px] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden pointer-events-auto relative"
                        >
                            {/* Shimmer Effect */}
                            <div className="absolute inset-0 bg-gradient-to-br from-[#EAC54F]/5 via-transparent to-transparent pointer-events-none" />
                                        ...
                                        <div className="flex items-center justify-between mb-8">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/[0.08] flex items-center justify-center">
                                                    <MessageSquare size={20} className="text-[#EAC54F]" />
                                                </div>
                                                <div>
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-6">
                                                    ...
                                                    {['bug', 'suggestion', 'other'].map((type) => (
                                                        <button
                                                            ...
                                                            className={`py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider border transition-all ${feedbackType === type
                                                                ? 'bg-[#EAC54F]/10 border-[#EAC54F] text-[#EAC54F]'
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full bg-white/[0.02] border border-white/[0.08] rounded-2xl px-5 py-4 text-sm text-white placeholder:text-zinc-600 outline-none focus:border-[#EAC54F]/50 focus:ring-1 focus:ring-[#EAC54F]/20 transition-all resize-none"
                                                />
                                            </div>
